...
public class OSImageCompression {
    private final String TAG = OSImageCompression.class.getName();

    private final Context context;
    private final Uri imageUri;

    public OSImageCompression(Context context, Uri imageUri) {
    ...
    public File compress() {
        File image;
        try {
            image = OSFileUtils.from(context, imageUri);
