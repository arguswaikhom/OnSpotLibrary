...
public class DotsBounce extends LinearLayout {
    ...
    public DotsBounce(Context context2) {
        super(context2);
    }

    public DotsBounce(Context context2, AttributeSet attributeSet) {
    ...
    public DotsBounce(Context context2, AttributeSet attributeSet, int i) {
